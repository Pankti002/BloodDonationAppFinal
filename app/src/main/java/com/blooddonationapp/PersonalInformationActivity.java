...
import com.blooddonationapp.LoginActivity;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Utils.DONOR_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    String[] data=LoginActivity.getLoginCredentials();
                    String loginEmail=data[0];
                    String loginPassword=data[1];
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if((strEmail.equals(loginEmail)) && (strPassword.equals(loginPassword))) {
